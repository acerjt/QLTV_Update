...
Public Class ChiTietBaoCaoMuonSachTheoTheLoai_DAL
    ...
    Public Function selectListChiTiet(ByRef TheLoai As String, ByRef Nam As String, ByRef Thang As String, ByRef ChiTiet As ChiTietBaoCaoMuonSachTheoTheLoai_DTO, ByRef TongSoLuotMuon As String) As Result  'ex: 18222229
            ...
            Using comm As New SqlCommand()
                ...
                Try
                    ...
                    If reader.HasRows = True Then
                        ...
                        While reader.Read()
                            ChiTiet = (New ChiTietBaoCaoMuonSachTheoTheLoai_DTO(reader("TenTheLoaiSach"), reader("SoLuotMuon"), reader("TyLe")))

                            TongSoLuotMuon = reader("TongSoLuotMuon")

                        End While
                    Else
                        'If IsDBNull(reader("TongSoLuotMuon")) Then
                        TongSoLuotMuon = 0
            ...
            Using comm As New SqlCommand()
                ...
                Try
                    ...
                    If reader.HasRows = True Then
                        listChiTiet.Clear()
                        While reader.Read()
                            listChiTiet.Add(New ChiTietBaoCaoMuonSachTheoTheLoai_DTO(reader("TenTheLoaiSach"), reader("SoLuotMuon"), reader("TyLe"), reader("Thang"), reader("Nam")))
                        End While
                    End If
